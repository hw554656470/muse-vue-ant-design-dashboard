<template>
    <a-card class="main-card">
        <!-- 公用tab组件 -->
        <publictab :tabs="tabs"  :currentKey="2"></publictab>
...
export default {
    data() {
        return {
            ...
            tabs: [
                { title: "预约审批", key: "0" ,path:"/appointmentForApproval"},
...
.main-container-modal-title {
    ...
    justify-content: space-between;
    align-items: center;
    .main-container-modal-title-left {
        display: flex;
        .line {
            width: 4px;
            height: 15px;
    ...
    .main-container-modal-title-right {
        width: 36px;
        height: 35px;
        background: #2474f6;
...
.main-container-modal-content {
    .userinfo {
        ...
        img {
            border: 2px solid #1f6ab7;
            border-radius: 5px;
        }
        .userinfo-describe {
            line-height: 17px;
            .userinfo-describe-top {
                font-size: 14px;
            }
            .userinfo-describe-status {
                i {
